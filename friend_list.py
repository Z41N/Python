...
#Created a message using all 3 names in the list. Used some methods to kind of play around with them. Purposely messed up the formatting of the names in the list aboveeee just so I can use methods lol
